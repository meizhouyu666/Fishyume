...
Fishyume `0.2.1-alpha.1` includes M4.0 + M4.1: Agent Driver contracts, Headless Protocol v1, Context Compiler v1, and a formal `codex + local` Driver. The CLI still starts the Go Engine over stdio; the persistent Control Plane/IPC and MCP layers are later M4.2/M4.3 work.
